...
<html lang="en">
    <head>
        <?php
            $title = "Kabar Astronomi - Kelola Artikel"; 
            include '../../head.php';
        ?>
    </head>
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="portfolio">
            <div class="container">
                ...
                <form action="submit.php" method="get">
                    <button type="submit" class="btn btn-lg btn-dark btn-block">Tambah Artikel</button>
                </form>
                <br>
                <form method="GET" action="admin.php">
                    ...
                    <li style="margin-bottom: 20px; display: flex; align-items: center;">
                        ...
                        <div>
                            ...
                            <p style="margin: 5px 0;">
                                <?= substr(trim(preg_replace('/\s+/', ' ', strip_tags(str_replace('</', ' </', $row['content'])))), 0, 100) ?>...
                            </p>
